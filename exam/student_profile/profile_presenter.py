...
def _load_section_titles(sections_db: str) -> dict[str, str]:
    """Load and lightly clean section titles for profile display."""
    ...
    for section_id, title in rows:
        if section_id and title:
            ...
            titles[section_id] = clean or title
    return titles
...
def build_profile_response(
    ...
    return {
        ...
        "topics": _build_topics_json(profile, bandit_states, section_titles),
